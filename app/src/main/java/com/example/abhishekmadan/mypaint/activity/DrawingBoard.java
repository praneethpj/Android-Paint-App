...
public class DrawingBoard extends AppCompatActivity implements View.OnClickListener,
    ...
    private SeekBar mBrushStrokeSeeKBar, brush_tranparent_seek_bar;
    String ImageDecode = "";
    private String Imageecode;
    ...
    public void init() {
        ...
        mOperationRecyclerView =   findViewById(R.id.oper_recyclerview);
         ...
         */
        mColorPalletNavView =  findViewById(R.id.navigation_view);
        mBlackColor =   findViewById(R.id.black_color);
        mBlackColor.setOnClickListener(this);
        mBlueColor =   findViewById(R.id.blue_color);
        mBlueColor.setOnClickListener(this);
        mGreenColor =   findViewById(R.id.green_color);
        mGreenColor.setOnClickListener(this);
        mOrangeColor =  findViewById(R.id.orange_color);
        mOrangeColor.setOnClickListener(this);
        mPinkColor =   findViewById(R.id.pink_color);
        mPinkColor.setOnClickListener(this);
        mSkyblueColor =   findViewById(R.id.skyblue_color);
        mSkyblueColor.setOnClickListener(this);
        mRedColor =   findViewById(R.id.red_color);
        mRedColor.setOnClickListener(this);
        mVioletColor =   findViewById(R.id.violet_color);
        mVioletColor.setOnClickListener(this);
        mWhiteColor =   findViewById(R.id.white_color);
         ...
         */
        mBrushStrokeSeeKBar =   findViewById(R.id.brush_thickness_seek_bar);
        brush_tranparent_seek_bar =   findViewById(R.id.brush_tranparent_seek_bar);
        mBrushStrokeSeeKBar.setOnSeekBarChangeListener(this);
        brush_tranparent_seek_bar.setOnSeekBarChangeListener(this);
        mPaintCanvas =  findViewById(R.id.drawing_canvas);

        brush_tranparent_seek_bar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                if(progress ==1){

                    mBlackColor.setTag("#1A000000");
                    mBlueColor.setTag("#1A0000ff");
                    mGreenColor.setTag("#1A00ff00");
                    mOrangeColor.setTag("#1Affbb00");
                    mPinkColor.setTag("#1AFE2EF7");
                    mRedColor.setTag("#1Aff0000");
                    mSkyblueColor.setTag("#1A01DFD7");
                    mVioletColor.setTag("#1A8904b1");
                    mWhiteColor.setTag("#1Affffff");
                }
                if(progress ==2){

                    mBlackColor.setTag("#33000000");
                    mBlueColor.setTag("#330000ff");
                    mGreenColor.setTag("#3300ff00");
                    mOrangeColor.setTag("#33ffbb00");
                    mPinkColor.setTag("#33FE2EF7");
                    mRedColor.setTag("#33ff0000");
                    mSkyblueColor.setTag("#3301DFD7");
                    mVioletColor.setTag("#338904b1");
                    mWhiteColor.setTag("#33ffffff");

                }
                if(progress ==3){

                    mBlackColor.setTag("#4D000000");
                    mBlueColor.setTag("#4D0000ff");
                    mGreenColor.setTag("#4D00ff00");
                    mOrangeColor.setTag("#4Dffbb00");
                    mPinkColor.setTag("#4DFE2EF7");
                    mRedColor.setTag("#4Dff0000");
                    mSkyblueColor.setTag("#4D01DFD7");
                    mVioletColor.setTag("#4D8904b1");
                    mWhiteColor.setTag("#4Dffffff");
                }
                if(progress ==4){

                    mBlackColor.setTag("#66000000");
                    mBlueColor.setTag("#660000ff");
                    mGreenColor.setTag("#6600ff00");
                    mOrangeColor.setTag("#66ffbb00");
                    mPinkColor.setTag("#66FE2EF7");
                    mRedColor.setTag("#66ff0000");
                    mSkyblueColor.setTag("#6601DFD7");
                    mVioletColor.setTag("#668904b1");
                    mWhiteColor.setTag("#66ffffff");
                }
                if(progress ==5){

                    mBlackColor.setTag("#80000000");
                    mBlueColor.setTag("#800000ff");
                    mGreenColor.setTag("#8000ff00");
                    mOrangeColor.setTag("#80ffbb00");
                    mPinkColor.setTag("#80FE2EF7");
                    mRedColor.setTag("#80ff0000");
                    mSkyblueColor.setTag("#8001DFD7");
                    mVioletColor.setTag("#808904b1");
                    mWhiteColor.setTag("#80ffffff");
                }
                if(progress ==6){

                    mBlackColor.setTag("#99000000");
                    mBlueColor.setTag("#990000ff");
                    mGreenColor.setTag("#9900ff00");
                    mOrangeColor.setTag("#99ffbb00");
                    mPinkColor.setTag("#99FE2EF7");
                    mRedColor.setTag("#99ff0000");
                    mSkyblueColor.setTag("#9901DFD7");
                    mVioletColor.setTag("#998904b1");
                    mWhiteColor.setTag("#99ffffff");
                }
                if(progress ==7){

                    mBlackColor.setTag("#B3000000");
                    mBlueColor.setTag("#B30000ff");
                    mGreenColor.setTag("#B300ff00");
                    mOrangeColor.setTag("#B3ffbb00");
                    mPinkColor.setTag("#B3FE2EF7");
                    mRedColor.setTag("#B3ff0000");
                    mSkyblueColor.setTag("#B301DFD7");
                    mVioletColor.setTag("#B38904b1");
                    mWhiteColor.setTag("#B3ffffff");
                }
                if(progress ==8){

                    mBlackColor.setTag("#CC000000");
                    mBlueColor.setTag("#CC0000ff");
                    mGreenColor.setTag("#CC00ff00");
                    mOrangeColor.setTag("#CCffbb00");
                    mPinkColor.setTag("#CCFE2EF7");
                    mRedColor.setTag("#CCff0000");
                    mSkyblueColor.setTag("#CC01DFD7");
                    mVioletColor.setTag("#CC8904b1");
                    mWhiteColor.setTag("#CCffffff");
                }
                if(progress ==9){

                    mBlackColor.setTag("#E6000000");
                    mBlueColor.setTag("#E60000ff");
                    mGreenColor.setTag("#E600ff00");
                    mOrangeColor.setTag("#E6ffbb00");
                    mPinkColor.setTag("#E6FE2EF7");
                    mRedColor.setTag("#E6ff0000");
                    mSkyblueColor.setTag("#E601DFD7");
                    mVioletColor.setTag("#E68904b1");
                    mWhiteColor.setTag("#E6ffffff");
                }
                if(progress ==10){

                    mBlackColor.setTag("#FF000000");
                    mBlueColor.setTag("#FF0000ff");
                    mGreenColor.setTag("#FF00ff00");
                    mOrangeColor.setTag("#FFffbb00");
                    mPinkColor.setTag("#FFFE2EF7");
                    mRedColor.setTag("#FFff0000");
                    mSkyblueColor.setTag("#FF01DFD7");
...
//        Log.i("After Compress Dimension", afterBitmap.getWidth() + "-" + afterBitmap.getHeight());
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == IMG_RESULT && resultCode == RESULT_OK) {
            ...
            Imageecode = getCompresssedImages(ImageDecode);
            mPaintCanvas.setCanvasBackground(BitmapFactory.decodeFile(Imageecode));
            compressedImages = (BitmapFactory.decodeFile(Imageecode));
        ...
        if (requestCode == Constants.RESULT_LOAD_IMAGE  ) {
                ...
                mPaintCanvas.setCanvasBackground(bitmap);
            }
